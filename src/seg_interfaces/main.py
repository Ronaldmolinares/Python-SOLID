from src.seg_interfaces.notifier import EmailNotifier, PhoneNotifier
from src.seg_interfaces.payment_data import ContactInfo, CustomerData, PaymentData
from src.seg_interfaces.payment_processor import (
    OfflinePaymentProcessor,
    StripePaymentProcessor,
)
from src.seg_interfaces.payment_service import PaymentService
...
if __name__ == "__main__":
    ...
    customer_data_with_email = CustomerData(
        name="Robert Kiyosaki", contact_info=ContactInfo(email="robert@gmail.com")
    )
    customer_data_with_phone = CustomerData(
        name="Jasmin Brown", contact_info=ContactInfo(phone="3203485566")
    )
    ...
    sms_notifier = PhoneNotifier(sms_gateway)
